...
- No data migration; depends on the TASK-0001 internal input contract.

## Test plan

- Add focused success/failure regression tests for the acceptance criterion.
- Run `python scripts/quality_gate.py all --path . --task TASK-0002`.
