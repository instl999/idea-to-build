...
- If a stored format changes, provide an explicit local migration and rollback; otherwise record none.

## Test plan

- Add focused success/failure regression tests for the acceptance criterion.
- Run `python scripts/quality_gate.py all --path . --task TASK-0003`.
