...
from idea_to_build_lib import IdeaToBuildError, load_json, load_state, render_research_report, safe_project_path, save_state
...
def main():
    ...
    output = safe_project_path(root, "docs/live/RESEARCH.md"); output.parent.mkdir(parents=True, exist_ok=True); output.write_text(report, encoding="utf-8")
