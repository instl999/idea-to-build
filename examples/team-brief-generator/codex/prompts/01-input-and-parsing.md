...
You own only this workstream: Implement validated note ingestion and deterministic parsing
...
- Use branch `codex/01-input-and-parsing` in worktree `../team-brief-generator-01-input-and-parsing`.
...
- Must complete: Implement validated note ingestion and deterministic parsing
