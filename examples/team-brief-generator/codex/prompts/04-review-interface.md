...
You own only this workstream: Build the accessible review workflow
...
- Use branch `codex/04-review-interface` in worktree `../team-brief-generator-04-review-interface`.
...
- Must complete: Build the accessible review workflow
