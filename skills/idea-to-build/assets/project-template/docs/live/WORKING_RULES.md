...
- Time: `{{CREATED_AT}}`
- Evidence: Initial Idea-to-Build template only. Run the `sync-rules` prompt against the real repository before implementation and replace this line with inspected files/commands.