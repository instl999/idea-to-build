...
def main():
    parser = argparse.ArgumentParser(description=__doc__); parser.add_argument("--path", required=True); parser.add_argument("--format", choices=("json", "text"), default="json"); args = parser.parse_args(); result = render_context(args.path)
